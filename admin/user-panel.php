<?php 
    ...
    $tablerows = array(
        array(
            'id'=>'lylith_pro_user_name',
            'title'=>'Teljes név',
        ),
        array(
            'id'=>'lylith_pro_user_email',
            'title'=>'Email cím',
        ),
        array(
            'id'=>'lylith_pro_user_phone',
            'title'=>'Telefon',
        ),
        array(
            'id'=>'lylith_pro_user_address',
...
<div class="tab-pane fade show active bg-white flex-grow-1" role="tabpanel" aria-labelledby="admin_user" id="admin_user_tab">
    <div class="w-100 h-100 d-flex flex-column p-5 gap-2 ">
        <h4 class="h5 fw-bold"><?php echo __('Felhasználó adatai', 'lylith-pro')?></h4>
        <h5 class="h6 fw-normal"><?php echo __('Céges kapcsolattartó vagy oldal felhasználó', 'lylith-pro')?></h5>
                    ...
                    <tr scope="row">
                        ...
                        <td>
                            <button class="btn btn-link text-success text-decoration-none" data-shortcode="<?php echo $row['id']?>">
                                <span><svg style=" color:inherit" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path fill="currentColor" d="M160 0c-23.7 0-44.4 12.9-55.4 32H48C21.5 32 0 53.5 0 80V400c0 26.5 21.5 48 48 48H192V176c0-44.2 35.8-80 80-80h48V80c0-26.5-21.5-48-48-48H215.4C204.4 12.9 183.7 0 160 0zM272 128c-26.5 0-48 21.5-48 48V448v16c0 26.5 21.5 48 48 48H464c26.5 0 48-21.5 48-48V256H416c-17.7 0-32-14.3-32-32V128H320 272zM160 40a24 24 0 1 1 0 48 24 24 0 1 1 0-48zm256 88v96h96l-96-96z"/></svg><span>
                            </button>
                        </td>
                    </tr>
