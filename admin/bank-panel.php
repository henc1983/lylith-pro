<?php 
    $tablerows = array(
        array(
            'id'=>'lylith_pro_bank_name',
            'title'=>'Bank neve',
        ),
        array(
            'id'=>'lylith_pro_bank_address',
            'title'=>'Székhely',
        ),
        array(
            'id'=>'lylith_pro_bank_phone',
            'title'=>'Telefon',
        ),
        array(
            'id'=>'lylith_pro_bank_openingtime',
            'title'=>'Ügyfélfogadási idő',
        ),
        array(
            'id'=>'lylith_pro_bank_account',
            'title'=>'Számlaszám',
        ),
        array(
            'id'=>'lylith_pro_bank_owner',
            'title'=>'Kedvezményezett',
        ),
        array(
            'id'=>'lylith_pro_bank_notice',
            'title'=>'Közlemény rovat',
        ),
        array(
            'id'=>'lylith_pro_bank_swift',
            'title'=>'SWIFT vagy BIC',
        ),
    );

?>

<div class="tab-pane fade bg-white flex-grow-1" role="tabpanel" aria-labelledby="admin_bank" id="admin_bank_tab">
    <div class="w-100 h-100 d-flex flex-column p-5 gap-2 ">
        <h4 class="h5 fw-bold"><?php echo __('Banki információk', 'lylith-pro')?></h4>
        <h5 class="h6 fw-normal "><?php echo __('Utaláshoz szükséges adatok', 'lylith-pro')?></h5>
            ...
            <table class="table align-middle">
                <thead class="table-light">
                    <tr>
                        ...
                        <th scope="col" class="text-end">Rövidkód</th>
