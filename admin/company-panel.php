<?php 
    $tablerows = array(
        array(
            'id'=>'lylith_pro_company_name',
            'title'=>'Vállalkozás neve',
        ),
        array(
            'id'=>'lylith_pro_company_contact',
            'title'=>'Kapcsolattartó vagy vezető',
        ),
        array(
            'id'=>'lylith_pro_company_phone',
            'title'=>'Telefon',
        ),
        array(
            'id'=>'lylith_pro_company_email',
            'title'=>'Email',
        ),
        array(
            'id'=>'lylith_pro_company_headquarters',
            'title'=>'Székhely',
        ),
        array(
            'id'=>'lylith_pro_company_location',
            'title'=>'Telephely',
        ),
        array(
            'id'=>'lylith_pro_company_lettering',
            'title'=>'Levelezési cím',
        ),
        array(
            'id'=>'lylith_pro_company_taxnumber',
            'title'=>'Adószám',
        ),
        array(
            'id'=>'lylith_pro_company_registernumber',
            'title'=>'Cégjegyzék szám',
        ),
        array(
            'id'=>'lylith_pro_company_accountant',
            'title'=>'Könyvelő neve',
        ),
        array(
            'id'=>'lylith_pro_company_accountant_address',
            'title'=>'Könyvelő címe',
        ),
        array(
            'id'=>'lylith_pro_company_accountant_phone',
            'title'=>'Könyvelő telefonszáma',
        ),
    );

?>
<div class="tab-pane fade bg-white flex-grow-1" role="tabpanel" aria-labelledby="admin_company" id="admin_company_tab">
    <div class="w-100 h-100 d-flex flex-column p-5 gap-2 ">
        <h4 class="h5 fw-bold"><?php echo __('Vállalkozás adatai', 'lylith-pro')?></h4>
        <h5 class="h6 fw-normal"><?php echo __('Cég vagy magánvállalkozás', 'lylith-pro')?></h5>
